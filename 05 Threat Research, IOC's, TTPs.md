...
- Another example: system settings are being changed (not a bad thing by itself) while no one with administrative privileges is logged in (and now it's a bad thing)
